...
public class EmployeBean {
    ...
    public void loadEmployeesByService(int serviceId) {
        // Adjust your logic to fetch employees based on the selected service
        employes = employeService.getEmployeesByService(serviceId);
    }
